...
<div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
        ...
        <div class="row ">
            ...
            <tr>
                ...
                <th data-sortable="true" aria-sort="ascending" class="datatable" style="width: 19.30835734870317%;">
                    <a href="#" class="datatable">Fecha de Ingreso</a>
                </th>
                <th data-sortable="true" aria-sort="ascending" class="datatable" style="width: 19.30835734870317%;">
                    <a href="#" class="datatable">Clasificación</a>
                </th>
                <th data-sortable="true" aria-sort="ascending" class="datatable" style="width: 19.30835734870317%;">
                    <a href="#" class="datatable">Entrega</a>
                </th>
                <th data-sortable="true" aria-sort="ascending" class="datatable" style="width: 19.30835734870317%;">
                ...
                <th data-sortable="true" aria-sort="ascending" class="datatable" style="width: 19.30835734870317%;">
                    <a href="#" class="datatable">Acción</a>
                </th>
                <!-- <th data-sortable="true" aria-sort="ascending" class="datatable" style="width: 19.30835734870317%;">
                    <a href="#" class="datatable">descrip</a>
                </th>
                <th data-sortable="true" aria-sort="ascending" class="datatable" style="width: 19.30835734870317%;">
                    <a href="#" class="datatable">Observ</a>
                </th>-->
            ...
            ?>
               ...
               <td><?php echo $fila["tipo_de_entrega"]; ?></td>
